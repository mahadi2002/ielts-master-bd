...
-- ============================================================
-- SEED (starter — expand per your band-6/7/8/9 word list)
-- ============================================================

-- Example row shape only; replace with real curated content before launch.
-- INSERT INTO words (id, headword, ipa, part_of_speech, definition_en, definition_bn,
--   example_sentence, synonyms, ielts_band_level, task_tag, is_exclusive, frequency_rank)
-- VALUES (UUID(), 'ubiquitous', '/juːˈbɪkwɪtəs/', 'adjective',
--   'present, appearing, or found everywhere', 'সর্বত্র বিদ্যমান',
--   'Smartphones have become ubiquitous in modern life.',
--   JSON_ARRAY('omnipresent','universal'), 8, 'task2', FALSE, 1200);
