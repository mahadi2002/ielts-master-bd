<section class="section container">
  ...
  <?php if (empty($words)): ?>
    <div class="empty-state">
      ...
      <p>আজকের জন্য কোনো Review বাকি নেই। নতুন শব্দ শিখতে <a href="/learn" class="link-primary">Learn</a>-এ যান।</p>
    </div>
  <?php else: ?>
    <div id="js-review-stage" class="max-w-520 mt-24">
      <?php foreach ($words as $i => $w): ?>
        <div class="card review-card js-review-item<?= $i === 0 ? ' is-active' : '' ?>" data-progress-id="<?= e($w['id']) ?>">
